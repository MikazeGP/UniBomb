...
public class FadeManager : MonoBehaviour
{
	...
	/// <param name='scene'>シーン名</param>
	/// <param name='interval'>暗転にかかる時間(秒)</param>
    public void MonobitLoadLevel(string scene,float interval) {

        StartCoroutine(MonobitTransScene(scene, interval));
    }
    ...
    private IEnumerator MonobitTransScene(string scene,float interval) {
        ...
        //シーン切替 .
        MonobitEngineBase.MonobitNetwork.LoadLevel(scene);
